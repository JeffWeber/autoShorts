...
An autonomous pipeline for writing, revising, and typesetting a complete
novel. From a seed concept to a print-ready PDF — all generated by AI agents.
...
### Phase 4: Export
Rebuild docs, typeset in LaTeX, generate PDF.

See [PIPELINE.md](PIPELINE.md) for the full technical specification.

---

## Tools (21 Python scripts)
