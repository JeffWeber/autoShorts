...
def call_reader(reader_key, arc_summary):
    ...
    raw = call_llm("judge", READER_PROMPT.format(arc_summary=arc_summary),
                    system=reader["system"], temperature=0.7, max_tokens=4000, timeout=300)
...
def call_collection_reader(reader_key, story_summaries, story_count):
    ...
    raw = call_llm("judge", prompt, system=reader["system"], temperature=0.7,
